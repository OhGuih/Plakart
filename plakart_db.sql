...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/02/2025 às 22:53
...
(1, 'Teste Junior', 3, '2025-02-02 00:34:12', '2025-02-02 00:34:12');
...
CREATE TABLE `equipes` (
  ...
  `chefe_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, '2025_02_01_182739_create_pilotos_table', 1),
(6, '2025_02_01_182744_create_campeonatos_table', 2);
...
(1, 'Julio', 12, '2025-02-02 01:21:25', '2025-02-02 01:21:25'),
(2, 'Eduardo', 55, '2025-02-02 01:21:25', '2025-02-02 01:21:25');
...
ALTER TABLE `equipes`
  ...
  ADD KEY `chefe_pilotos` (`chefe_id`);
...
--
ALTER TABLE `equipes`
  ADD CONSTRAINT `campeonato_id` FOREIGN KEY (`campeonato_id`) REFERENCES `campeonatos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chefe_pilotos` FOREIGN KEY (`chefe_id`) REFERENCES `pilotos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
